...
class assetWidgetPlaceholder extends assetWidget {
  ...
  public function instanceRenderPreview(&$vars) {
    ...
    $vars['content']['placeholder'] = array(
      '#markup' => '<div class="asset-placeholder"><div class="fa fa-'.$asset_type->data['icon'].'"><div class="asset-placeholder-hide">&nbsp;</div></div>&nbsp;&nbsp;<strong>'.$asset_type->title.':</strong> '.$vars['asset']->title.'</div>',
    );
